					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style"
							...
							<li class="nav-item active open"><a href="#"
								...
								<ul class="sub-menu">
									<li class="nav-item"><a href="all_professors.html"
									...
									<li class="nav-item active"><a href="edit_professor.html"
						...
						<div class="col-sm-12">
							<div class="card-box">
								...
								<div class="card-body" id="bar-parent2">
									<form method="post" id="form_sample_2" action="/edit_pro">
										<input hidden value="${teacher.id }">
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												<label>First Name</label> <input type="text" name="name"
													...
													value="${teacher.name }" required="required">
											</div>
										</div>
										<br>
										<div class="form-row">
											<div class="form-group col-md-6">
												<label>Last Name</label> <input type="text"
													...
													value="${teacher.lastName }" placeholder="Last Name"
													required="required">
											</div>
											<div class="form-group col-md-6">
												<label>Email Id</label> <input type="email" name="emailId"
													value="${teacher.emailId }" class="form-control"
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label>Department</label> <select
													...
													<option hidden
														value="${teacher.department.stdName }" selected>${teacher.department.stdName }</option>
											...
											<div class="form-group col-md-6">
												<label>Gender</label> <select class="custom-select mr-sm-2"
													...
													<option hidden value="${teacher.gender }" selected>${teacher.gender }</option>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="inputCity">MobileNo</label> <input type="number"
													...
													placeholder="Mobile No" value="${teacher.mobileNo }">
											</div>
											<div class="form-group col-md-6">
