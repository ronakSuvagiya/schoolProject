					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form action="/edit_stu" method="post">
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="name" class="mdl-textfield__input" type="text" id="txtFirstName" value="${student.name }">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="lastName" class="mdl-textfield__input" type="text" id="txtLasttName"  value="${student.lastName }">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="rollno" class="mdl-textfield__input" type="text" id="txtRollNo"  value="${student.rollNo }">
											<input name="oldrollno" class="mdl-textfield__input" type="hidden" id="txtRollNo"  value="${student.rollNo }">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input name="std" class="mdl-textfield__input" type="text" id="list2" value="${student.std.stdName}" readonly
												tabIndex="-1">
												<input name="oldstd" class="mdl-textfield__input" type="hidden" id="list2" value="${student.std.stdName}" readonly
												tabIndex="-1">
											...
											<ul data-mdl-for="list2" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
												<c:forEach items="${StdName }" var="std">
													<li class="mdl-menu__item" value="${std.id}" data-val="DE">${std.stdName }</li>
												</c:forEach>
											</ul>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
											<input name="div" class="mdl-textfield__input" type="text" id="list3" value="${student.divId.name }" readonly
												tabIndex="-1">
											<label for="list3" class="pull-right margin-0">
												<i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
											</label>
											<label for="list3" class="mdl-textfield__label">Div</label>
											<ul data-mdl-for="list3" id="divElement" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
												<li class="mdl-menu__item">A</li>
												<li class="mdl-menu__item" data-val="BY">B</li>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
											<input name="gender" class="mdl-textfield__input" type="text" id="sample2" value="${student.gender }"
												readonly tabIndex="-1">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="dob" class="mdl-textfield__input" type="text" id="dateOfBirth" value="${student.dob }">
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
											<textarea name="address" class="mdl-textfield__input" rows="4" id="text7">${student.address }</textarea>
