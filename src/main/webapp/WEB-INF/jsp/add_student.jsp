...
<body
							...
							<div class="card-box">
								...
								<div class="card-body" id="bar-parent2">
									<form action="/add_stu" method="post">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												<label>Department</label> <select
													class="custom-select mr-sm-2" name="std"
													required="required" id="list2">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label>Div</label> <select
													class="custom-select mr-sm-2" name="div"
													required="required" id="divElement">
													<option value="" selected>Choose...</option>
												</select>
											</div>
											<div class="form-group col-md-6">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<textarea name="address" name="address" placeholder="address" class="form-control" rows="4" id="text7"></textarea> 
											</div>
											<div class="form-group col-md-6">
	...
	$("#list2").change(function(){
		$('#divElement').find('option').remove();
		$.ajax({url: "http://localhost:8081/findByStd?std="+$(this).val()+"&school=<c:out value='${school}'></c:out>", 
			success: function(result){
				for(var i =0; i<result.length;i++)
					{
					  var node = document.createElement("option");
					  node.setAttribute("value",result[i].name);
					  var textnode = document.createTextNode(result[i].name);
					  node.appendChild(textnode);
					  componentHandler.upgradeElement(node);
					  var list = document.getElementById("divElement");
