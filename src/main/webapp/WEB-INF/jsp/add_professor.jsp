						...
						<ul class="sidemenu  page-header-fixed slimscroll-style"
							...
							<li class="nav-item active open"><a href="#"
								...
								<ul class="sub-menu">
									...
									<li class="nav-item"><a href="edit_professor"
										class="nav-link "> <span class="title">Edit
												Professor</span>
									</a></li>
									<li class="nav-item"><a href="professor_profile"
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle"><i
								...
								<ul class="sub-menu">
									...
									<li class="nav-item"><a href="add_student_bootstrap"
										class="nav-link "> <span class="title">Add Student
												Bootstrap</span>
									</a></li>
									<li class="nav-item"><a href="edit_student"
										class="nav-link "> <span class="title">Edit Student</span>
									</a></li>
									<li class="nav-item"><a href="student_profile"
										class="nav-link "> <span class="title">About
												Student</span>
									</a></li>
								</ul></li>
							<li class="nav-item"><a href="#" class="nav-link nav-toggle"><i
								...
								<ul class="sub-menu">
									...
									<li class="nav-item"><a href="edit_parent"
										class="nav-link "> <span class="title">Edit Parent</span>
									</a></li>
									<li class="nav-item"><a href="parent_profile"
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle">
								...
								<ul class="sub-menu">
									<li class="nav-item"><a href="all_courses"
										class="nav-link "> <span class="title">All Courses</span>
									</a></li>
									<li class="nav-item"><a href="add_course"
										class="nav-link "> <span class="title">Add Course</span>
									</a></li>
									<li class="nav-item"><a href="add_course_bootstrap"
										class="nav-link "> <span class="title">Add Course
												Bootstrap</span>
									</a></li>
									<li class="nav-item"><a href="edit_course"
										class="nav-link "> <span class="title">Edit Course</span>
									</a></li>
									<li class="nav-item"><a href="course_details"
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle">
								...
								<ul class="sub-menu">
									<li class="nav-item"><a href="all_department"
										class="nav-link "> <span class="title">All
												Departments</span>
									</a></li>
									...
									<li class="nav-item"><a href="add_department_bootstrap"
										class="nav-link "> <span class="title">Add
												Department Bootstrap</span>
									</a></li>
									<li class="nav-item"><a href="edit_department"
										class="nav-link "> <span class="title">Edit
												Department</span>
									</a></li>
								</ul></li>
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle">
								...
								<ul class="sub-menu">
									<li class="nav-item"><a href="fees_collection"
									...
									<li class="nav-item"><a href="add_fees_bootstrap"
										class="nav-link "> <span class="title">Add Fees
												Bootstrap</span>
									</a></li>
									<li class="nav-item"><a href="fees_receipt"
