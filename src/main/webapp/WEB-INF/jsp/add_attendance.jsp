...
<body
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Attendance &nbsp;<i class="fa fa-angle-right"></i></li>
                                    ...
                                    <form>
                                        <div class="form-group row">
                                            ...
                                            <div class="input-append date form_date" data-date-format="dd-mm-yyyy"
                                                ...
                                                <input size="27" type="text" value="" readonly>
                                        ...
                                        <div class="form-group row">
											...
											<div class="input-append">
                                                <select size="8" class="form-control  select2">
										...
										<div class="form-group row">
											<label class="col-md-4 control-label">Select Div</label>
											<div class="input-append">
                                                <select size="8" class="form-control  select2">
                                                    <option value="">Select a state</option>
                                                    <optgroup label="Alaskan/Hawaiian Time Zone">
										...
										<div class="form-group row">
                                            <label class="col-md-4 control-label">Enter Roll Number</label>
                                            <div class="input-append">
												<input size="27" type="text" class="tags tags-input" data-type="tags"/>
                                            </div>
                                        </div>
    ...
    <script src="../assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker-init.js"
