					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style"
							...
							<li class="nav-item active open"><a href="#"
								...
								<ul class="sub-menu">
									<li class="nav-item active"><a href="all_students.html"
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="">Students</a>&nbsp;<i
																...
																<tbody>
																	...
																	<c:forEach items="${studentList }" var="student">
																		<tr class="odd gradeX">
																			...
																			<td>${student.dob }</td>
																			<td>${student.std.stdName }</td>
																			<td>${student.divId.name }</td>
																			<td>${student.address }</td>
																			<td><a href="edit_student?id=${student.id }"
														...
														<div class="card-body no-padding ">
															<div class="doctor-profile">
																...
																<div class="profile-usertitle">
																	<div class="doctor-name">${student.name }&nbsp;${student.lastName }</div>
																	<div class="name-center">Roll No:-
																		${student.rollNo }</div>
																</div>
																<p>
																	<td>${student.address }</td>
